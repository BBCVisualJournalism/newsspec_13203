...
define([
    ...
    var tooltip = React.createClass({displayName: "tooltip",
        ...
        render: function () {
            ...
            return (
                React.createElement("div", {style: cssStyle, className: "tooltip"}, React.createElement("strong", null, this.state.name), " ", React.createElement("span", null, "(", this.state.percentage, "%)"))
            );
        }
    });
